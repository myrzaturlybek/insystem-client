// Если добавите новую иконку убедитесь что есть белая версия(в папке public/images/).
...
export default [
  ...
  { title: "Отзывы", icon: "star", url: "/cabinets/reviews" },
  { title: "Подписки", icon: "plus", url: "/cabinets/subscriptions" },
  { title: "Аналитика", icon: "pie-chart", url: "/cabinets/analytics" },
  { title: "Продвижение", icon: "trending-up", url: "/cabinets/promotion" },
  { title: "Тарифы", icon: "sliders", url: "/cabinets/tariffs" },
  { title: "Настройка", icon: "settings", url: "/cabinets/settings" },
  { title: "Помощь", icon: "help-circle", url: "/cabinets/help" },
  { title: "Выйти", icon: "log-out", url: "/cabinets/logout" },
];
